...
final class CharacterListView: UIView, CharacterListViewProtocol {
    private var loadingView = ActivityView()
    private var tableView: UITableView = {
        let tableView = UITableView()
//        tableView.register(UINib(nibName: "CharacterListTableViewCell", bundle: nil), forCellReuseIdentifier: CharacterListTableViewCell.identifier)
