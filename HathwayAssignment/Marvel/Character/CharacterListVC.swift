...
final class CharacterListViewController: UIViewController  {
    ...
    var itemInfo: IndicatorInfo = "Characters"
    ...
    init(
        ...
        customView: CharacterListViewProtocol & UIView, itemInfo: IndicatorInfo
    ) {
...
extension CharacterListViewController:  IndicatorInfoProvider {
